 ...
 * Descrição  : Painel administrativo de projetos em página única. 
...
<main>
    <div class="container">
        <h1 class="titulo-secao">⚙️ Painel Administrativo</h1>
        ...
        <h2 class="titulo-secao">
            <?php echo $em_edicao ? '✏️ Editar projeto' : '➕ Novo projeto'; ?>
        </h2>
        ...
        <?php if (empty($projetos)): ?>
            <p class="texto-vazio">Nenhum projeto encontrado neste filtro.</p>
        <?php else: ?>
                            ...
                            <td>
                                <div class="acoes-tabela">
                                    ...
                                    <?php if ($p['status'] != 'arquivado'): ?>
                                        <form action="admin.php" method="post" style="margin: 0;" onsubmit="return confirm('Arquivar este projeto?');">
                                            <input type="hidden" name="acao" value="arquivar">
                                            <input type="hidden" name="id" value="<?php echo (int) $p['id']; ?>">
                                            <button type="submit" class="btn-perigo" style="padding: 6px 12px; font-size: 13px;">🗑️ Arquivar</button>
                                        </form>
                                    <?php endif; ?>
                                </div>
                            </td>
            ...
            <p class="contador-projetos">
                <?php echo count($projetos); ?> projeto(s) listado(s)
            </p>
        <?php endif; ?>
