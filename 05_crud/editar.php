 ...
 * Data       : [02/04/2026]
 * Descrição  : coseguir editar usado o ID
 */
...
if (!$projeto) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $link_github    = trim($_POST['link_github']      ??'');
         ...
         $sql = 'UPDATE projetos SET nome = :nome,
                descricao   = :descricao,
...
<body>
   ...
   <?php if ($erro): ?>
    ...
    class="formulario">
<div class="campo">
    <label calss="label-campo"> Nome do projeto * </label>
...
<div class="campo">
    <label class="label-campo">Link GitHub (opcional)</
    label>
